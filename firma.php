            ...
            <tr>
               ...
               <td style="width: 300px;" valign="bottom">
                  <table cellspacing="0" cellpadding="0" style="width: 285px; background: transparent !important;">
                     <tbody>
                        <tr>
                           <td style="padding-bottom: 13px;"><span style="FONT-SIZE: 14pt; COLOR: #e64444; font-family: Arial, sans-serif; line-height: 19pt"><strong>%%FirstName%% %%LastName%%</strong></span><span style="FONT-SIZE: 12pt; line-height: 14pt; font-family: Arial, sans-serif; COLOR: #393939; font-weight: bold;"><br>%%Title%%</span></td>
                        </tr>
                        <tr>
                           <td style="padding-top: 13px; FONT-SIZE: 11pt; line-height: 14pt; font-family: Arial, sans-serif; COLOR: #2e666b;"><a href="mailto:%%Email%%" style="font-size: 11pt; font-family: Arial, sans-serif; color: #2e666b; text-decoration: none;"><span style="font-size: 11pt; font-family: Arial, sans-serif; color: #2e666b; text-decoration: none;">%%Email%%</span></a></td>
                        </tr>
                        <tr>
